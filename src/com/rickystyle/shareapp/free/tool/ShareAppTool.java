...
public class ShareAppTool {
     ...
     * @param labelName
     */
    public static void shareapp(final Resources res, final Activity act, final String packageName, final String labelName) {
     ...
     * @param labelName
     */
    public static void shareQR(final Activity act, final ShareAppDialog.Builder shareAlert, final String packageName, final String labelName) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                Looper.prepare();
