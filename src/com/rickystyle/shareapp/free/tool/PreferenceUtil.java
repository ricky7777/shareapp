...
public class PreferenceUtil {
    ...
    public static void saveToBookmark(Context context, PackageManager mPm, AppInfoBean info) {
        Editor editor = getSharedPreferences(context).edit();
        String packageName = ShareAppConsts.PREF_BOOKMARK_KEY + info.getPackageName();
